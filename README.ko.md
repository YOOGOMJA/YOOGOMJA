...
### GCOO (맥락: 1.5M MAU 앱)
- 지도 폴리곤 렌더링 시간을 **58.19% 단축**하고 배포 시간을 **76.6% 단축**했습니다.
- 애셋 압축 기반 개선으로 모바일 애셋 크기를 **83.51% 축소**했습니다.

### AI Delivery Pipeline at Dable
- Jira 분석부터 Playwright 시각 검증까지 AI 기반 워크플로를 구축했습니다.
- 위젯 구현 시간을 **90%+**, 이슈 파악 시간을 **90%** 단축했습니다.

### Mobile Platform Template
- Turborepo, Expo, FSD 기반 공용 모바일 템플릿을 구축했습니다.
- 신규 프로젝트 세팅 시간을 **2주 -> 3일**로 단축했습니다.
